...
<body>
	...
	<script type="text/javascript" src="//apis.daum.net/maps/maps3.js?apikey=53fa6c2185becddc7ca0ea02b6c4992a&libraries=services"></script>
	<script type="text/javascript" language="javascript" src="js/result.js"></script>
	<script type="text/javascript" language="javascript">
		var addr = '<?php echo $_POST["addr"]; ?>'; // 맞는 코드(addr에 전달됨)
		...
		geocoder.addr2coord(addr, function(status, result) {
			...
			if (status === daum.maps.services.Status.OK) {
				...
				map = makeMap(coords); // result.js 파일에 들어있는 함수
