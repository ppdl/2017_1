...
<div class="container" style="left:30vw; width:70vw; padding:30px;">
	<form id="register" method="POST" action="registerProcess.php">
  <table >
		<tr>
      <td>아이디: </td>
    ...
    <tr>
		  <td>생년월일: </td>
      <td><input id="BDAY" name="BDAY" type="text" placeholder="yymmdd (예:921205)" onblur="checkbdy();checkall();"></td>
      <td><span id="birthcheck"></span></td>
    </tr>
    <tr>
		  <td>휴대전화: </td>
      <td><input id="PHONE" name="PHONE" type="text" placeholder="010-1234-5678" onblur="checkphone();checkall()"></td>
      <td><span id="phonecheck"></span></td>
    </tr>
    <tr>
		  <td>이메일: </td>
      <td><input id="EMAIL" name="EMAIL" type="text" placeholder="email@portal.com" onblur="checkemail();checkall()"></td>
      <td><span id="emailcheck"></span></td>
    </tr>
    <tr>
      <td> </td>
		  <td><input id="btn" type="submit" value="가입" disabled></td>
    </tr>
    </table>
	</form>
</div>
