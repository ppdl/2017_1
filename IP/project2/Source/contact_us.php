...
<head>
  ...
  ul.nav li a:hover{
   ...
   table{text-align:center;width:500px;height:200px;margin:auto;}
   @keyframes navHover{
    from{}
...
<nav class="navbar navbar-inverse" style="background-color:white; border:0px solid #35b9d6;">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        if(!isset($_SESSION['user_id'])){
          ...
          ?><a href="index.php" style="color:#223d93; font-weight:bold">LOGOUT</a><?php
        }
        ?></li>
      </ul>
    </div>
    ...
    <table border="1">
      <tr>
        <td rowspan="2">연세대학교</td>
        <td>1599-1855
      </tr>
      <tr>
        <td><a href="https://www.facebook.com/ysuniversity/" target="_blank">페이스북</a></td>
      </tr>
      <tr>
        <td rowspan="2">인터넷컴퓨팅 연구실</td>
        <td>02)2123-5712</td>
      </tr>
      <tr>
        <td><a href="http://icl.yonsei.ac.kr/" target="_blank">http://icl.yonsei.ac.kr</a></td></tr>
    </table>
  </div>
</nav>
